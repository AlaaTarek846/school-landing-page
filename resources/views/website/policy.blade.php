...
<style>
    ...
    <section class="inner-banner">
        ...
        <div class="container">
            <div class="inner-title text-center">
                <h2 class="text-white">{{ __('website.Privacy Policy') }}</h2>
                <span class="text-white-50">{{ __('website.home') }} / {{ __('website.Privacy Policy') }}</span>
            </div>
        </div>
    </section>
    <!-- Inner Banner End -->
    ...
    <!-- Privacy Policy Area -->
    <section class="privacy-policy-area pb-5">
        <div class="container">
