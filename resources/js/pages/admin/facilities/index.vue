...
<!--                <button @click="showModelCreate" class="btn btn-sm btn-primary-light">-->
...
export default {
  ...
  setup(){
    ...
    // Watch modalShow to open modal programmatically
    watch(modalShow, (newValue) => {
      if (newValue) {
        var myModal = new bootstrap.Modal(document.getElementById('facilities-model'));
        myModal.show();
      }
    });
