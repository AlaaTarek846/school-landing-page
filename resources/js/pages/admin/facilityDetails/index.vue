          ...
          <div class="card custom-card">
            <div class="card-header justify-content-between">
              <div class="prism-toggle">
                <button @click="showModelCreate" class="btn btn-sm btn-primary-light" data-bs-toggle="modal" data-bs-target="#facility-details-model">
              ...
              <div class="table-responsive mb-2">
                <table class="table text-nowrap table-striped">
                  ...
                  <tr>
                    ...
                    <th scope="col">{{ $t('global.count') }}</th>
                  ...
                  <tr v-for="(item,index) in data" :key="item.id">
                    ...
                    <td>{{item.title_en}}</td>
                    <td>{{item.count}}</td>
                    <td>{{item.facility ? (item.facility.title_ar + ' / ' + item.facility.title_en) : '-'}}</td>
                    <td>
                      <div class="hstack gap-2 fs-15">
                        <button
                                @click.prevent="showEditMode(item)"
                                data-bs-toggle="modal" data-bs-target="#facility-details-model"
