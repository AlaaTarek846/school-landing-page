          ...
          <div class="card custom-card">
            <div class="card-header justify-content-between">
              <div class="prism-toggle">
                <button @click="showModelCreate" class="btn btn-sm btn-primary-light" data-bs-toggle="modal" data-bs-target="#campus-tours-model">
                ...
                <table class="table text-nowrap table-striped">
                  ...
                  <tr v-for="(item,index) in data" :key="item.id">
                    ...
                    <td>
                      ...
                      <div class="me-3" v-if="item.type == 'image'">
                        <span class="avatar avatar-xxl bg-light">
                            <img :src="item.content" alt="" style="width: 100%; height: 100%">
                        </span>
                      </div>
                      <div v-else-if="item.type == 'video'">
                           <video width="150" height="100" controls :src="item.content"></video>
                      </div>
                      <div v-else>
                           <a :href="item.content" target="_blank">Link</a>
                      </div>
                    </td>
                    <td>{{item.title_ar}}</td>
                    <td>
                      <div class="hstack gap-2 fs-15">
                        <button
                                ...
                                data-bs-toggle="modal" data-bs-target="#campus-tours-model"
